...
type Response struct {
	...
	Data *Member `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *Response) GetData() *Member {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pb_user_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x94, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x12, 0x1a, 0x0a, 0x08, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x44, 0x12, 0x1e, 0x0a, 0x0a,
	0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	...
	,
...
var file_pb_user_proto_goTypes = []interface{}{
	(*Member)(nil),   // 0: user.Member
	(*Response)(nil), // 1: user.Response
	(*Meta)(nil),     // 2: user.Meta
}
var file_pb_user_proto_depIdxs = []int32{
	2, // 0: user.Response.meta:type_name -> user.Meta
	0, // 1: user.Response.data:type_name -> user.Member
	0, // 2: user.Users.Register:input_type -> user.Member
	0, // 3: user.Users.UpdateStatus:input_type -> user.Member
	1, // 4: user.Users.Register:output_type -> user.Response
	1, // 5: user.Users.UpdateStatus:output_type -> user.Response
...
type UsersClient interface {
	Register(ctx context.Context, in *Member, opts ...grpc.CallOption) (*Response, error)
	UpdateStatus(ctx context.Context, in *Member, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *usersClient) Register(ctx context.Context, in *Member, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *usersClient) UpdateStatus(ctx context.Context, in *Member, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/user.Users/UpdateStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	Register(context.Context, *Member) (*Response, error)
	UpdateStatus(context.Context, *Member) (*Response, error)
}
...
func (*UnimplementedUsersServer) Register(context.Context, *Member) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (*UnimplementedUsersServer) UpdateStatus(context.Context, *Member) (*Response, error) {
...
func _Users_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).Register(ctx, req.(*Member))
	}
...
func _Users_UpdateStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.Users/UpdateStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).UpdateStatus(ctx, req.(*Member))
	}
	return interceptor(ctx, in, info, handler)
}
